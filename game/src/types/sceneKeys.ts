export enum SceneKeys {
    STORY_CHAT_VIEW_SCENE_KEY = "StoryChatViewScene",
    SINGLE_TEXT_CHAT_VIEW_SCENE_KEY = "TextChatViewScene",

    ACHIEVEMENT_VIEW_SCENE_KEY = "AchievementViewScene",
    HAT_VIEW_SCENE_KEY = "HatViewScene",
    ...
    WORLD_VIEW_SCENE_KEY = "WorldViewScene",
    UI_SCENE_KEY = "UiScene",
